...
public class WordDocument {
	...
	public static void saveScreenshotsToWordDocument(String documentName, String screenshotName,String TestResultsDocPath,String TestResultsScreenshotsPath,String StepText) throws IOException, XmlException 
	{
		System.out.println("Document Name is : " + documentName);
		System.out.println("Image File name : " +screenshotName);
		...
		headerRun.setText("Yugandhar Royal - Automation Labs");
		headerRun.addBreak();
		Utilitymethods obj = new Utilitymethods();
		String curr_date=obj.getCurrentDate();
		headerRun.setText("Execution Start Date & Time : "+curr_date);
		...
		//for (String file : screenshotNames) {
			...
			FileOutputStream out=new FileOutputStream(TestResultsDocPath+documentName + ".doc");
			doc.write(out);
			out.close();
	...
	public static XWPFDocument CreatingWordDocument(String UserStoryName) throws IOException, XmlException 
	{
		...
		//Title in the center ( Test Case Name )
				p.setAlignment(ParagraphAlignment.CENTER);
				r.setBold(true);
				r.setFontFamily("Verdana");
				r.setText(UserStoryName);
		return doc;
	...
	public static void pasteScreenshotToWord(XWPFDocument doc,String screenshotName,String TestResultsScreenshotsPath,String StepText,String documentName,String TestResultsDocPath) throws IOException, XmlException 
	{
	XWPFParagraph p=doc.createParagraph();//paragraph allignments, borders
	XWPFRun r=p.createRun();//Set font styles, colors, next line
	...
	public static void closingWordDoc(XWPFDocument doc,String documentName,String TestResultsDocPath) throws IOException, XmlException 
	{
		FileOutputStream out=new FileOutputStream(TestResultsDocPath+documentName + ".doc");
		try{doc.write(out);}catch (Exception e){}
		out.close();
	System.out.println("Word document Successfully created for "+documentName);
